...
var est = $('#estados option:selected').val();
TableProdPed = $('#table_productos_pedidos').DataTable({
  ...
  function productosPedidosAll(){
    ...
    $.ajax({
    type: "POST",
    url: "pedido/productospedidos_todos",
    dataType: 'json',
    data: {
        estado : 'default',
    },
...
$(document).ready(function(){
   ...
   // productosPedidosAll();
    ...
    $(document).on("click","#buscardor", function(event){
